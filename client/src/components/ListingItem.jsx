        ...
        return (
                ...
                transition-shadow overflow-hidden rounded-lg w-full sm:w-[330px]'>
                        <Link to={`/listing/${listing._id}`}>
                                <img src={listing.imageUrls[0] || "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRMd0Bubr913PXadrmq9ZHmwFGcFHrfJQnhuwEDRdU8V7GYZ2HuwqKKDpYCkqHO3no9EE8&usqp=CAU"}
                                        alt="listing cover"
                                        className='h-[320px] sm:h-[220px] w-full
                               object-cover hover:scale-105 transition-scale 
                               duration-300'/>
                                <div className='p-3 flex flex-col gap-2 w-full'>
                                        {/* w-full will make all elemennts to cover whole card */}
